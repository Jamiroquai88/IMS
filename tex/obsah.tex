...
Obraty (alebo aj obehy, poprípade turnusy) ru¹òov a ru¹novodièov sú rozdelené do dvoch kategórii - na osobnú dopravu\cite{obratyOS} a nákladnú dopravu\cite{obratyCARGO}, vychádzali sme z obehov pre rok 2015. Obehy vlakových èiat si vypracúva ka¾dá stanica samostatne, tie k dispozícii bohu¾iaµ nemáme\cite{gulikMail}.
...
\label{sec:gvdmodel}
Model grafikonu vychádza z GVD 2015\cite{gvdSR} pre trate uvedené v kapitole \ref{sec:gvd}. Pre úèely modelu ®S ®ilina sme GVD zjednodu¹ili a v¾dy uviedli len stanicu, s ktorou je konkrétna linka osobnej vlakovej dopravy prepojená (zastávky vlakov osobnej dopravy závisia od kategórie vlaku).\\
...
Dostupné údaje sa v¹ak týkajú len vlakov kategórie InterCity za obdobie február - máj 2015 prechádzajúce cez ®S Bratislava, preto sme pre ostatné kategórie vlakov urèili priemerné exponenciálne oneskorenie so stredom pa» minút. 
